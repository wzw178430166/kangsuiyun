    ...
    <div class="list_2_2">
      <div class="formDiv">
        <form action="" method="post" id="myform">
          <?php if($groupid==1) { ?> <?php echo $str;?> <br> <?php echo $mon_str;?> <?php } ?>
      ...
      <table width="100%" class="sortTable tableList" id="allTopTab" style="">
          <thead>
            <tr style="background-color: rgb(239, 245, 250); ">
              <th width="50"></th>
              <th width="85" class="sortNumeric clickable">当前页面金额总数（单位：元）</th>
            </tr>
          </thead>
          <tbody>
        ...
        <table width="100%" class="sortTable tableList" id="allTopTab" style="">
          <thead>
            <tr style="background-color: rgb(239, 245, 250); ">
              <th width="50">序号</th>
              <th width="85" class="sortNumeric clickable">订单号</th>
              ...
              <th width="85" class="sortAlpha clickable">支付状态</th>
              <th width="85" class="sortAlpha clickable">支付方法</th>
              <th width="85" class="sortNumeric clickable">金额(单位:元)</th>
              ...
              <th width="85" class="sortNumeric clickable">支付时间</th>
          ...
          <tr style="background-color: rgb(230, 245, 255); "> <?php } ?>
            ...
            <td><?php if($r['paytime']) echo date("Y-m-d H:i",$r['paytime']);?></td>
            <td><?php $r['nickname']? print($r['nickname']) : print($r['contactname']);?></td>
