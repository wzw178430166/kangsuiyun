...
<div class="list">
  <div class="list_1">
    ...
    <div class="list_1_2" style="padding-top:1px;padding-left:11px">每月数据汇总：</div>
  ...
  <div class="list_2">
    <div class="list_2_2">
      <div class="formDiv">
       <?php if($_GET['me']) { ?>
        <form action="" method="post" id="myform" onSubmit="jssubmit()">
             ...
             <tr>
                ...
                ?>
                    ...
                    <select name="end_time">
                    	<?php $n=1; if(is_array($end_timea)) foreach($end_timea AS $k => $r) { ?>
                    	<option value="<?php echo $k;?>" <?php if($k==$end_time) { ?>selected<?php } ?>><?php echo $r;?></option>
                        <?php $n++;}unset($n); ?>
                    </select>
                    -
                    <select name="start_time">
                        <?php $n=1; if(is_array($start_timea)) foreach($start_timea AS $k => $r) { ?>
                    	<option value="<?php echo $k;?>" <?php if($k==$start_time) { ?>selected<?php } ?>><?php echo $r;?></option>
                        <?php $n++;}unset($n); ?>
                    </select>
      ...
      <table width="100%" class="sortTable tableList" id="allTopTab" style="">
          <thead>
            <tr style="background-color: rgb(239, 245, 250); ">
              <th width="50"></th>
              <th width="85" class="sortNumeric clickable">发币数量</th>
              <th width="85" class="sortNumeric clickable">站长收益</th>
            </tr>
          </thead>
          <tbody>
        ...
        <table width="100%" class="sortTable tableList" id="allTopTab" style="">
          <thead>
            <tr style="background-color: rgb(239, 245, 250); ">
              ...
              <th width="20%" class="sortAlpha clickable">当月详单查询</th>
            </tr>
          </thead>
          <tbody>
